...
${OBJECTDIR}/geneticLHS.o: geneticLHS.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror -I../bclib -std=c++98 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/geneticLHS.o geneticLHS.cpp

${OBJECTDIR}/improvedLHS.o: improvedLHS.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror -I../bclib -std=c++98 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/improvedLHS.o improvedLHS.cpp

${OBJECTDIR}/maximinLHS.o: maximinLHS.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror -I../bclib -std=c++98 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/maximinLHS.o maximinLHS.cpp

${OBJECTDIR}/optSeededLHS.o: optSeededLHS.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror -I../bclib -std=c++98 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/optSeededLHS.o optSeededLHS.cpp

${OBJECTDIR}/optimumLHS.o: optimumLHS.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror -I../bclib -std=c++98 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/optimumLHS.o optimumLHS.cpp

${OBJECTDIR}/randomLHS.o: randomLHS.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror -I../bclib -std=c++98 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/randomLHS.o randomLHS.cpp

${OBJECTDIR}/utilityLHS.o: utilityLHS.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror -I../bclib -std=c++98 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utilityLHS.o utilityLHS.cpp
