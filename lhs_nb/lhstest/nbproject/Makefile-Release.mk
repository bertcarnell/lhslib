...
${OBJECTDIR}/geneticLHS_RTest.o: geneticLHS_RTest.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror -I../lhslib -I../bclib -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/geneticLHS_RTest.o geneticLHS_RTest.cpp

${OBJECTDIR}/improvedLHS_RTest.o: improvedLHS_RTest.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror -I../lhslib -I../bclib -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/improvedLHS_RTest.o improvedLHS_RTest.cpp

${OBJECTDIR}/main.o: main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror -I../lhslib -I../bclib -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp

${OBJECTDIR}/maximinLHS_RTest.o: maximinLHS_RTest.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror -I../lhslib -I../bclib -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/maximinLHS_RTest.o maximinLHS_RTest.cpp

${OBJECTDIR}/optSeededLHS_RTest.o: optSeededLHS_RTest.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror -I../lhslib -I../bclib -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/optSeededLHS_RTest.o optSeededLHS_RTest.cpp

${OBJECTDIR}/optimumLHS_RTest.o: optimumLHS_RTest.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror -I../lhslib -I../bclib -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/optimumLHS_RTest.o optimumLHS_RTest.cpp

${OBJECTDIR}/randomLHS_RTest.o: randomLHS_RTest.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror -I../lhslib -I../bclib -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/randomLHS_RTest.o randomLHS_RTest.cpp

${OBJECTDIR}/utilityLHS_RTest.o: utilityLHS_RTest.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror -I../lhslib -I../bclib -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utilityLHS_RTest.o utilityLHS_RTest.cpp
